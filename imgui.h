...
struct Point_2 {
    ...
    Point_2(const double lat_, const double lon_) : lat(lat_), lon(lon_),  pos(0, 0) {}
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddConcavePolyFilledCustom(const Polygon_2& polygon, const std::vector<N>& indices, ImU32 col);
